...
class AtmLogAnalyzer(ctk.CTk, TkinterDnD.DnDWrapper):
    ...
    def create_sidebar(self):
        ...
        def draw_code_scroll():
            # Geser semua baris yang ada ke bawah
            for line_id in self.active_lines[:]: # Gunakan copy list untuk iterasi yang aman saat menghapus
            ...
            self.after(150, draw_code_scroll)

        # Mulai animasi
        self.after(500, draw_code_scroll)
